...
-- use "using " key when two table have a same columns.

-- Group By Department name with Average Salary
...
--         MONTH
--         FROM order_date
--     ) as order_month, count(order_date) as Total_order
-- from orders
-- GROUP BY
--     order_month;
